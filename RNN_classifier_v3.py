...
test_x_cpu = Variable(test_data[0], volatile=True).type(torch.FloatTensor)[:3696]  # shape (2000, 28, 28) value in range(0,1)
test_y = test_data[1].numpy().squeeze()[:3696]    # covert to numpy array
